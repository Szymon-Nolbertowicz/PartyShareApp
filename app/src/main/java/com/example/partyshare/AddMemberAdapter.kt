...
data class AddMemberAdapter(private val users: MutableList<user>) : RecyclerView.Adapter<AddMemberAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.user_row_add, parent, false)
